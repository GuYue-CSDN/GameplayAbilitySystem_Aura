...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	FString(TEXT("Input Tag for Passive Ability 1"))
	);

	GameplayTags.InputTag_Passive_2 = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("InputTag.Passive.2"),
		FString(TEXT("Input Tag for Passive Ability 2"))
	);
	...
	*/
	GameplayTags.Abilities_None = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("No Abilities - like the nullptr for Ability Tags")
		); 
	...
	*/
	...
	FString("Tag for blocking player input pressed")
	);
	GameplayTags.Player_Block_InputHeld = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.InputHeld"),
		FString("Tag for blocking player input held")
	);
	GameplayTags.Player_Block_InputReleased = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.InputReleased"),
		FString("Tag for blocking player input released")
	);
